...
<p>This time the common ratio of the geometric series is <span class="math">\(\alpha(1-\theta)\)</span>. As before we can plug our common ratio into the general solution for the sum of a geometric series:</p>
